/*! @name videojs-contrib-eme @version 3.5.0 @license Apache-2.0 */
(function (global, factory) {
  ...
  var defaultPlayreadyGetLicense = function defaultPlayreadyGetLicense(keySystemOptions) {
    return function (emeOptions, keyMessage, callback) {
      requestPlayreadyLicense(keySystemOptions, keyMessage, emeOptions, function (err, response, responseBody) {
        if (err) {
          callback(err);
          return;
        }
  ...
  var addKeyToSession = function addKeyToSession(options, session, event, eventBus) {
    ...
    requestPlayreadyLicense(playreadyOptions, event.message.buffer, options, function (err, response) {
      if (eventBus) {
        eventBus.trigger('licenserequestattempted');
      }
