...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: utils/SupportedDevices.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: utils/SupportedDevices.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import Bowser from 'bowser';
