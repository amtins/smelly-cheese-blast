...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: mediaPlayer/components/menu/items/srg-menu-item.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: mediaPlayer/components/menu/items/srg-menu-item.js</h1>
