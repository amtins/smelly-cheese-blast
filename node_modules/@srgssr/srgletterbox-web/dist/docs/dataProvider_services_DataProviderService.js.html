...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: dataProvider/services/DataProviderService.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: dataProvider/services/DataProviderService.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import MediaComposition from '../model/MediaComposition.js';
...
class DataProviderService {
  ...
  getEndScreenList(bu, mediaType, id, pageSize = 18) {
    ...
    if (['rts', 'srf'].includes(buToLowerCase) &amp;&amp; mediaType.toLowerCase() === 'video') {
