...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: mediaPlayer/components/endScreen/replay-button.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: mediaPlayer/components/endScreen/replay-button.js</h1>
