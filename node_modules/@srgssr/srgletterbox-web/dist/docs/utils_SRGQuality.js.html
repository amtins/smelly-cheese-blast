...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: utils/SRGQuality.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: utils/SRGQuality.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>export const list = ['SD', 'HD', 'HQ'];
export const types = {
  HD: list[1],
  HQ: list[2],
  SD: list[0],
...
export function containQualities(resources, qualities = [types.SD, types.HD]) {
  ...
  const filteredResources = resources
    ...
    .filter((resource, index, resourceList) => resourceList
      .findIndex(fi => (fi.quality === resource.quality)) === index);
