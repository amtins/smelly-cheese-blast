...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: mediaPlayer/components/menu/playbackRate/playback-rate-menu.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: mediaPlayer/components/menu/playbackRate/playback-rate-menu.js</h1>
