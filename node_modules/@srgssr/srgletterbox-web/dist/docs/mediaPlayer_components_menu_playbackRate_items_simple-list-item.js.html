...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: mediaPlayer/components/menu/playbackRate/items/simple-list-item.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: mediaPlayer/components/menu/playbackRate/items/simple-list-item.js</h1>
