...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: utils/AkamaiTokenService.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: utils/AkamaiTokenService.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>class AkamaiTokenService {
  /**
   * Get the acl path
   *
