...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: mediaPlayer/components/endScreen/continuous-playback-component.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: mediaPlayer/components/endScreen/continuous-playback-component.js</h1>
...
class ContinuousPlayback extends EndScreenFeature {
  ...
  mount({ mediaList, recommendationId }) {
    ...
    this.updateShowInformation(mediaList[0]);
  ...
  redirectToMedia() {
    ...
    this.triggerContinuousPlaybackHit(this.currentMediaURN);

    letterbox.prepareToPlayURN(
      this.currentMediaURN,
      undefined,
      {
  ...
  updateShowInformation({
    ...
    this.el().style.backgroundImage = `url(${decodeURIComponent(imageUrl)}${ImageProperties.WIDTH700})`;
    ...
    this.currentMediaURN = urn;
  }

  /**
   * @event srgssr/recommendationHit
   */
