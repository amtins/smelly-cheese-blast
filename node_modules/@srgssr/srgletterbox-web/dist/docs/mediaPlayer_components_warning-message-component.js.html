...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: mediaPlayer/components/warning-message-component.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: mediaPlayer/components/warning-message-component.js</h1>
...
class WarningMessageComponent extends ModalDialog {
  ...
  initListeners() {
    this.on(this.player(), SegmentService.BLOCKED_SEGMENT_SKIPPED, ({ data: reason }) => {
      ...
      if (errorType) {
        this.display(this.localize(errorType.message));
      }
    });
  }
