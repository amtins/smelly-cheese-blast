...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: utils/SRGTokenType.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: utils/SRGTokenType.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const TOKEN_TYPES = {
  AKAMAI: 'AKAMAI',
  NONE: 'NONE',
};
