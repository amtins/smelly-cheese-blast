...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: mediaPlayer/components/endScreen/cancel-button.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: mediaPlayer/components/endScreen/cancel-button.js</h1>
